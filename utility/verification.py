...
class Verification:
    ...
    def valid_proof(transactions, last_hash, proof):
        ...
        Arguments:
            :param transactions: The transactions of the block for 
            which the proof is created.
            :param last hash: The previous block's hash which 
            will be stored in the current block.
    ...
    def verify_transaction(transaction, get_balance, check_funds=True):
        """Verify a transaction by checking whether the sender has 
        sufficient coins.

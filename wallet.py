...
class Wallet:
    ...
    def save_keys(self):
        ...
        if self.public_key != None and self.private_key != None:
            try:
                with open(f'wallet-{self.node_id}.txt', mode='w') as file:
    ...
    def load_keys(self):
        ...
        try:
            with open(f'wallet-{self.node_id}.txt', mode='r') as file:
                keys = file.readlines()
    ...
    def generate_keys(self):
        ...
        return binascii.hexlify(private_key.exportKey(format='DER')).decode(
            'ascii'), binascii.hexlify(public_key.exportKey(format='DER')).decode('ascii')
